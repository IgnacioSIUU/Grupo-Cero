...
from .views import home,contacto,main_pinturas,Inf_imagen2,Inf_imagen,Inf_imagen3,main_esculturas,main_orfebreria,escultura1,escultura2,agregar_arte,listar_artes,mod_arte,del_arte,\
